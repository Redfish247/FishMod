 ...
 * {@code () -> false}, rendered from a {@code HudRenderCallback} registered in FishModInit.
 */
public class DungeonMapHud {
    ...
    /** Registered directly with HudRenderCallback in FishModInit — mirrors F7Huds.renderHud. */
    ...
    private static void drawSplit(DrawContext ctx, int x, int y, int size, int colorA, int colorB) {
        int half = size / 2;
