...
public enum DoorType {
    NORMAL_CLOSED((byte) MapColor.COLOR_BLACK.getPackedId(MapColor.Brightness.LOWEST)),
    NORMAL_OPEN((byte) 34),   // MapColor.SNOW.getPackedId(HIGH)
    ENTRANCE((byte) 30),      // MapColor.PLANT.getPackedId(HIGH)
    BLOOD((byte) 18),         // MapColor.FIRE.getPackedId(HIGH)
